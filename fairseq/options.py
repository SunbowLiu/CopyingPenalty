...
def add_generation_args(parser):
    ...
    group.add_argument('--copypen', default=1, type=float,
                       help='Copying penalty: <1.0 favors copying source tokens, >1.0 favors translating source tokens')
    group.add_argument('--target-dictionary-path', metavar='FILE',
                       help='path to target side dictionary, to obtain punctuation list')
